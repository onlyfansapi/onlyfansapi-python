...
class TestDirectMessages:
    ...
    def test_method_list(self, client: OnlyFansAPI) -> None:
        direct_message = client.engagement.messages.direct_messages.list(
            account="acct_XXXXXXXXXXXXXXX",
        )
        assert_matches_type(DirectMessageListResponse, direct_message, path=["response"])
    ...
    def test_raw_response_list(self, client: OnlyFansAPI) -> None:
        response = client.engagement.messages.direct_messages.with_raw_response.list(
            account="acct_XXXXXXXXXXXXXXX",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        direct_message = response.parse()
        assert_matches_type(DirectMessageListResponse, direct_message, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list(self, client: OnlyFansAPI) -> None:
        with client.engagement.messages.direct_messages.with_streaming_response.list(
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
    ...
    def test_path_params_list(self, client: OnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.engagement.messages.direct_messages.with_raw_response.list(
                account="",
            )
    ...
    def test_method_chart(self, client: OnlyFansAPI) -> None:
        direct_message = client.engagement.messages.direct_messages.chart(
            account="acct_XXXXXXXXXXXXXXX",
        )
        assert_matches_type(DirectMessageChartResponse, direct_message, path=["response"])
    ...
    def test_raw_response_chart(self, client: OnlyFansAPI) -> None:
        response = client.engagement.messages.direct_messages.with_raw_response.chart(
            account="acct_XXXXXXXXXXXXXXX",
        )
    ...
    def test_streaming_response_chart(self, client: OnlyFansAPI) -> None:
        with client.engagement.messages.direct_messages.with_streaming_response.chart(
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_chart(self, client: OnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.engagement.messages.direct_messages.with_raw_response.chart(
                account="",
            )


class TestAsyncDirectMessages:
    ...
    async def test_method_list(self, async_client: AsyncOnlyFansAPI) -> None:
        direct_message = await async_client.engagement.messages.direct_messages.list(
            account="acct_XXXXXXXXXXXXXXX",
        )
        assert_matches_type(DirectMessageListResponse, direct_message, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOnlyFansAPI) -> None:
        response = await async_client.engagement.messages.direct_messages.with_raw_response.list(
            account="acct_XXXXXXXXXXXXXXX",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        direct_message = await response.parse()
        assert_matches_type(DirectMessageListResponse, direct_message, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncOnlyFansAPI) -> None:
        async with async_client.engagement.messages.direct_messages.with_streaming_response.list(
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncOnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.engagement.messages.direct_messages.with_raw_response.list(
                account="",
            )
    ...
    async def test_method_chart(self, async_client: AsyncOnlyFansAPI) -> None:
        direct_message = await async_client.engagement.messages.direct_messages.chart(
            account="acct_XXXXXXXXXXXXXXX",
        )
        assert_matches_type(DirectMessageChartResponse, direct_message, path=["response"])
    ...
    async def test_raw_response_chart(self, async_client: AsyncOnlyFansAPI) -> None:
        response = await async_client.engagement.messages.direct_messages.with_raw_response.chart(
            account="acct_XXXXXXXXXXXXXXX",
        )
    ...
    async def test_streaming_response_chart(self, async_client: AsyncOnlyFansAPI) -> None:
        async with async_client.engagement.messages.direct_messages.with_streaming_response.chart(
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_chart(self, async_client: AsyncOnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.engagement.messages.direct_messages.with_raw_response.chart(
                account="",
            )
