...
from onlyfansapi.types.trial_links import (
    TagAddResponse,
    TagListResponse,
    TagRemoveResponse,
)
...
class TestTags:
    ...
    def test_method_list(self, client: OnlyFansAPI) -> None:
        tag = client.trial_links.tags.list(
            trial_link_id=123456789,
    ...
    def test_raw_response_list(self, client: OnlyFansAPI) -> None:
        response = client.trial_links.tags.with_raw_response.list(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
        )
    ...
    def test_streaming_response_list(self, client: OnlyFansAPI) -> None:
        with client.trial_links.tags.with_streaming_response.list(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
    ...
    def test_path_params_list(self, client: OnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.trial_links.tags.with_raw_response.list(
                trial_link_id=123456789,
                account="",
            )
    ...
    def test_method_add(self, client: OnlyFansAPI) -> None:
        tag = client.trial_links.tags.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    def test_raw_response_add(self, client: OnlyFansAPI) -> None:
        response = client.trial_links.tags.with_raw_response.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    def test_streaming_response_add(self, client: OnlyFansAPI) -> None:
        with client.trial_links.tags.with_streaming_response.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        ) as response:
    ...
    def test_path_params_add(self, client: OnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.trial_links.tags.with_raw_response.add(
                trial_link_id=123456789,
                account="",
                tags=["string"],
            )
    ...
    def test_method_remove(self, client: OnlyFansAPI) -> None:
        tag = client.trial_links.tags.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    def test_raw_response_remove(self, client: OnlyFansAPI) -> None:
        response = client.trial_links.tags.with_raw_response.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    def test_streaming_response_remove(self, client: OnlyFansAPI) -> None:
        with client.trial_links.tags.with_streaming_response.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        ) as response:
    ...
    def test_path_params_remove(self, client: OnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.trial_links.tags.with_raw_response.remove(
                trial_link_id=123456789,
                account="",
                tags=["string"],
            )
...
class TestAsyncTags:
    ...
    async def test_method_list(self, async_client: AsyncOnlyFansAPI) -> None:
        tag = await async_client.trial_links.tags.list(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
        )
        assert_matches_type(TagListResponse, tag, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOnlyFansAPI) -> None:
        response = await async_client.trial_links.tags.with_raw_response.list(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOnlyFansAPI) -> None:
        async with async_client.trial_links.tags.with_streaming_response.list(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncOnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.trial_links.tags.with_raw_response.list(
                trial_link_id=123456789,
                account="",
            )
    ...
    async def test_method_add(self, async_client: AsyncOnlyFansAPI) -> None:
        tag = await async_client.trial_links.tags.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    async def test_raw_response_add(self, async_client: AsyncOnlyFansAPI) -> None:
        response = await async_client.trial_links.tags.with_raw_response.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncOnlyFansAPI) -> None:
        async with async_client.trial_links.tags.with_streaming_response.add(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        ) as response:
    ...
    async def test_path_params_add(self, async_client: AsyncOnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.trial_links.tags.with_raw_response.add(
                trial_link_id=123456789,
                account="",
                tags=["string"],
            )
    ...
    async def test_method_remove(self, async_client: AsyncOnlyFansAPI) -> None:
        tag = await async_client.trial_links.tags.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    async def test_raw_response_remove(self, async_client: AsyncOnlyFansAPI) -> None:
        response = await async_client.trial_links.tags.with_raw_response.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        )
    ...
    async def test_streaming_response_remove(self, async_client: AsyncOnlyFansAPI) -> None:
        async with async_client.trial_links.tags.with_streaming_response.remove(
            trial_link_id=123456789,
            account="acct_XXXXXXXXXXXXXXX",
            tags=["string"],
        ) as response:
    ...
    async def test_path_params_remove(self, async_client: AsyncOnlyFansAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.trial_links.tags.with_raw_response.remove(
                trial_link_id=123456789,
                account="",
                tags=["string"],
            )
