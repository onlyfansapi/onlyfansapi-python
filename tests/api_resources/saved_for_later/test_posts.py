...
class TestPosts:
    ...
    def test_method_list(self, client: Onlyfansapi) -> None:
        post = client.saved_for_later.posts.list(
    ...
    def test_raw_response_list(self, client: Onlyfansapi) -> None:
        response = client.saved_for_later.posts.with_raw_response.list(
            account="acct_XXXXXXXXXXXXXXX",
            limit=10,
            offset=0,
        )
    ...
    def test_streaming_response_list(self, client: Onlyfansapi) -> None:
        with client.saved_for_later.posts.with_streaming_response.list(
            account="acct_XXXXXXXXXXXXXXX",
            limit=10,
            offset=0,
        ) as response:
    ...
    def test_path_params_list(self, client: Onlyfansapi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            client.saved_for_later.posts.with_raw_response.list(
                account="",
                limit=10,
                offset=0,
            )
...
class TestAsyncPosts:
    ...
    async def test_method_list(self, async_client: AsyncOnlyfansapi) -> None:
        post = await async_client.saved_for_later.posts.list(
            account="acct_XXXXXXXXXXXXXXX",
            limit=10,
            offset=0,
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncOnlyfansapi) -> None:
        response = await async_client.saved_for_later.posts.with_raw_response.list(
            account="acct_XXXXXXXXXXXXXXX",
            limit=10,
            offset=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOnlyfansapi) -> None:
        async with async_client.saved_for_later.posts.with_streaming_response.list(
            account="acct_XXXXXXXXXXXXXXX",
            limit=10,
            offset=0,
        ) as response:
    ...
    async def test_path_params_list(self, async_client: AsyncOnlyfansapi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account` but received ''"):
            await async_client.saved_for_later.posts.with_raw_response.list(
                account="",
                limit=10,
                offset=0,
            )
