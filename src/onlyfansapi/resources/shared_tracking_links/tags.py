...
from ...types.shared_tracking_links import tag_add_params, tag_remove_params
from ...types.shared_tracking_links.tag_add_response import TagAddResponse
from ...types.shared_tracking_links.tag_list_response import TagListResponse
from ...types.shared_tracking_links.tag_remove_response import TagRemoveResponse
...
class TagsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """Get tags for a specific shared Tracking Link.
        ...
        return self._get(
            path_template(
                "/api/{account}/shared-tracking-links/{shared_tracking_link_id}/tags",
                account=account,
    ...
    def remove(
        ...
        *,
        ...
        """Remove tags from a shared Tracking Link.

        Tag namespace is shared with owned
        Tracking Links. This is a free endpoint.

        Args:
          tags: Array of tag names to remove from the shared tracking link.
