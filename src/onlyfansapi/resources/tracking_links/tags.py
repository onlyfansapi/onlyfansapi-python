...
from ...types.tracking_links import tag_add_params, tag_remove_params
from ...types.tracking_links.tag_add_response import TagAddResponse
from ...types.tracking_links.tag_list_response import TagListResponse
from ...types.tracking_links.tag_remove_response import TagRemoveResponse
...
class TagsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """Get tags for a specific tracking link.
        ...
        return self._get(
            path_template(
                "/api/{account}/tracking-links/{tracking_link_id}/tags",
                account=account,
    ...
    def add(
        ...
        *,
        ...
        """Add tags to a specific tracking link.
    ...
    def remove(
        ...
        *,
        ...
        """Remove tags from a specific tracking link.

        This is a free endpoint.

        Args:
          tags: Array of tag names to remove from the tracking link.
