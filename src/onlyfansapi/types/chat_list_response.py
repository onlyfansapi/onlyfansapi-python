...
__all__ = [
    ...
    "DataFanHeaderThumbs",
    "DataFanListsState",
    "DataFanSubscribedByData",
    "DataFanSubscribedByDataSubscribe",
    "DataFanSubscribedOnData",
    "DataFanSubscribedOnDataSubscribe",
    "DataLastMessage",
    "DataLastMessageFromUser",
]
...
class DataFanAvatarThumbs(BaseModel):
    c144: Optional[str] = None

    c50: Optional[str] = None


class DataFanHeaderSize(BaseModel):
    height: Optional[int] = None

    width: Optional[int] = None


class DataFanHeaderThumbs(BaseModel):
    w480: Optional[str] = None

    w760: Optional[str] = None


class DataFanListsState(BaseModel):
...
class DataFanSubscribedByDataSubscribe(BaseModel):
...
class DataFanSubscribedByData(BaseModel):
    ...
    subscribes: Optional[List[DataFanSubscribedByDataSubscribe]] = None

    unsubscribe_reason: Optional[str] = FieldInfo(alias="unsubscribeReason", default=None)


class DataFanSubscribedOnDataSubscribe(BaseModel):
    id: Optional[int] = None
...
class DataFanSubscribedOnData(BaseModel):
    discount_finished_at: Optional[str] = FieldInfo(alias="discountFinishedAt", default=None)
    ...
    subscribes: Optional[List[DataFanSubscribedOnDataSubscribe]] = None
...
class DataFan(BaseModel):
    ...
    avatar_thumbs: Optional[DataFanAvatarThumbs] = FieldInfo(alias="avatarThumbs", default=None)
    ...
    finished_streams_count: Optional[int] = FieldInfo(alias="finishedStreamsCount", default=None)
    ...
    has_saved_streams: Optional[bool] = FieldInfo(alias="hasSavedStreams", default=None)
    ...
    header_size: Optional[DataFanHeaderSize] = FieldInfo(alias="headerSize", default=None)

    header_thumbs: Optional[DataFanHeaderThumbs] = FieldInfo(alias="headerThumbs", default=None)
    ...
    lists_states: Optional[List[DataFanListsState]] = FieldInfo(alias="listsStates", default=None)
    ...
    should_show_finished_streams: Optional[bool] = FieldInfo(alias="shouldShowFinishedStreams", default=None)
    ...
    subscribed_by_data: Optional[DataFanSubscribedByData] = FieldInfo(alias="subscribedByData", default=None)
    ...
    subscribed_on_data: Optional[DataFanSubscribedOnData] = FieldInfo(alias="subscribedOnData", default=None)
...
class DataLastMessageFromUser(BaseModel):
    id: Optional[int] = None
...
class DataLastMessage(BaseModel):
    ...
    from_user: Optional[DataLastMessageFromUser] = FieldInfo(alias="fromUser", default=None)
...
class Data(BaseModel):
    ...
    can_not_send_reason: Optional[bool] = FieldInfo(alias="canNotSendReason", default=None)

    can_send_message: Optional[bool] = FieldInfo(alias="canSendMessage", default=None)

    count_pinned_messages: Optional[int] = FieldInfo(alias="countPinnedMessages", default=None)

    fan: Optional[DataFan] = None

    has_purchased_feed: Optional[bool] = FieldInfo(alias="hasPurchasedFeed", default=None)

    has_unread_tips: Optional[bool] = FieldInfo(alias="hasUnreadTips", default=None)

    is_muted_notifications: Optional[bool] = FieldInfo(alias="isMutedNotifications", default=None)

    last_message: Optional[DataLastMessage] = FieldInfo(alias="lastMessage", default=None)

    last_read_message_id: Optional[int] = FieldInfo(alias="lastReadMessageId", default=None)

    unread_messages_count: Optional[int] = FieldInfo(alias="unreadMessagesCount", default=None)
