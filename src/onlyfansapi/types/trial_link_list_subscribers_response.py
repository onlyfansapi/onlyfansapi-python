...
__all__ = [
    ...
    "DataListSubscribedOnDataSubscribe",
]
...
class DataListPromoOffer(BaseModel):
...
class DataListSubscribedOnDataSubscribe(BaseModel):
    id: Optional[int] = None
...
class DataListSubscribedOnData(BaseModel):
    ...
    subscribes: Optional[List[DataListSubscribedOnDataSubscribe]] = None
...
class DataList(BaseModel):
    ...
    promo_offers: Optional[List[DataListPromoOffer]] = FieldInfo(alias="promoOffers", default=None)
...
class TrialLinkListSubscribersResponse(BaseModel):
