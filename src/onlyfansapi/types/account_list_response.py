...
__all__ = [
    "AccountListResponse",
    "AccountListResponseItem",
    "AccountListResponseItemOnlyfansUserData",
    "AccountListResponseItemOnlyfansUserDataAvatarThumbs",
    "AccountListResponseItemOnlyfansUserDataHasNewTicketReplies",
    "AccountListResponseItemOnlyfansUserDataHeaderSize",
    "AccountListResponseItemOnlyfansUserDataHeaderThumbs",
    "AccountListResponseItemOnlyfansUserDataUpload",
    "AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgs",
    "AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgsAdditional",
]


class AccountListResponseItemOnlyfansUserDataAvatarThumbs(BaseModel):
    c144: Optional[str] = None

    c50: Optional[str] = None


class AccountListResponseItemOnlyfansUserDataHasNewTicketReplies(BaseModel):
...
class AccountListResponseItemOnlyfansUserDataHeaderSize(BaseModel):
    height: Optional[int] = None

    width: Optional[int] = None


class AccountListResponseItemOnlyfansUserDataHeaderThumbs(BaseModel):
    w480: Optional[str] = None

    w760: Optional[str] = None


class AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgsAdditional(BaseModel):
    user: Optional[str] = None


class AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgs(BaseModel):
    additional: Optional[AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgsAdditional] = None
...
class AccountListResponseItemOnlyfansUserDataUpload(BaseModel):
    geo_upload_args: Optional[AccountListResponseItemOnlyfansUserDataUploadGeoUploadArgs] = FieldInfo(
        alias="geoUploadArgs", default=None
    )


class AccountListResponseItemOnlyfansUserData(BaseModel):
    ...
    avatar_thumbs: Optional[AccountListResponseItemOnlyfansUserDataAvatarThumbs] = FieldInfo(
        alias="avatarThumbs", default=None
    )
    ...
    has_new_ticket_replies: Optional[AccountListResponseItemOnlyfansUserDataHasNewTicketReplies] = FieldInfo(
    ...
    header_size: Optional[AccountListResponseItemOnlyfansUserDataHeaderSize] = FieldInfo(
        alias="headerSize", default=None
    )

    header_thumbs: Optional[AccountListResponseItemOnlyfansUserDataHeaderThumbs] = FieldInfo(
        alias="headerThumbs", default=None
    )
    ...
    upload: Optional[AccountListResponseItemOnlyfansUserDataUpload] = None
...
class AccountListResponseItem(BaseModel):
    id: Optional[str] = None

    authentication_progress: Optional[str] = None

    display_name: Optional[str] = None

    is_authenticated: Optional[bool] = None

    onlyfans_email: Optional[str] = None

    onlyfans_id: Optional[int] = None

    onlyfans_user_data: Optional[AccountListResponseItemOnlyfansUserData] = None

    onlyfans_username: Optional[str] = None


AccountListResponse: TypeAlias = List[AccountListResponseItem]
