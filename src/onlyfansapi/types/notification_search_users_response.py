...
class DataSubscribedOnDataSubscribe(BaseModel):
    id: Optional[int] = None
...
class DataSubscribedOnData(BaseModel):
    ...
    subscribes: Optional[List[DataSubscribedOnDataSubscribe]] = None
...
class NotificationSearchUsersResponse(BaseModel):
