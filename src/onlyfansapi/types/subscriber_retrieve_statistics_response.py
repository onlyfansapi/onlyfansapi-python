...
class Data(BaseModel):
    ...
    earnings: Optional[List[DataEarning]] = None

    subscribers: Optional[int] = None

    subscribes: Optional[List[DataSubscribe]] = None

    total: Optional[float] = None


class SubscriberRetrieveStatisticsResponse(BaseModel):
