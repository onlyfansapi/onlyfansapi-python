...
__all__ = ["NotificationGetCountsResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits", "Data"]
...
class Data(BaseModel):
    ...
    deactivated_media: Optional[int] = None
...
class NotificationGetCountsResponse(BaseModel):
