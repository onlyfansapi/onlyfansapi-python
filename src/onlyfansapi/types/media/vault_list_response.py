...
class DataListCounters(BaseModel):
...
class DataListFilesFull(BaseModel):
...
class DataListFiles(BaseModel):
    full: Optional[DataListFilesFull] = None
...
class DataListListState(BaseModel):
...
class DataListVideoSources(BaseModel):
...
class DataList(BaseModel):
    ...
    counters: Optional[DataListCounters] = None

    created_at: Optional[str] = FieldInfo(alias="createdAt", default=None)

    duration: Optional[int] = None

    files: Optional[DataListFiles] = None
    ...
    list_states: Optional[List[DataListListState]] = FieldInfo(alias="listStates", default=None)

    release_forms: Optional[List[object]] = FieldInfo(alias="releaseForms", default=None)

    type: Optional[str] = None

    video_sources: Optional[DataListVideoSources] = FieldInfo(alias="videoSources", default=None)
