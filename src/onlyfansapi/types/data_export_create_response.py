...
__all__ = ["DataExportCreateResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits", "Data"]
...
class Data(BaseModel):
    ...
    credit_calculation_note: Optional[str] = None

    end_date: Optional[str] = None

    file_type: Optional[str] = None

    requires_scraping: Optional[bool] = None
