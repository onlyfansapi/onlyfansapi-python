...
class DataListPaymentUser(BaseModel):
...
class DataListPayment(BaseModel):
    ...
    media_tax_amount: Optional[int] = FieldInfo(alias="mediaTaxAmount", default=None)
    ...
    user: Optional[DataListPaymentUser] = None
...
class DataList(BaseModel):
    ...
    payment: Optional[DataListPayment] = None
