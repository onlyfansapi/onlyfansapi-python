...
class DataDetailed(BaseModel):
    free_subscriptions: Optional[int] = None

    paid_subscriptions: Optional[int] = None

    unknown_subscriptions: Optional[int] = None


class Data(BaseModel):
    detailed: Optional[DataDetailed] = None

    new_subscriptions: Optional[int] = None

    renewed_subscriptions: Optional[int] = None

    total_subscriptions: Optional[int] = None


class StatisticGetSubscriberMetricsResponse(BaseModel):
