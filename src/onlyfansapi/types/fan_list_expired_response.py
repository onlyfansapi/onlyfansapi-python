...
__all__ = [
    ...
    "Data",
    "DataList",
    "DataListAvatarThumbs",
    "DataListHeaderSize",
    "DataListHeaderThumbs",
    "DataListListsState",
    "DataListSubscribedByData",
    "DataListSubscribedByDataSubscribe",
    "DataListSubscribedOnData",
    "DataListSubscriptionBundle",
]
...
class DataListAvatarThumbs(BaseModel):
    c144: Optional[str] = None

    c50: Optional[str] = None


class DataListHeaderSize(BaseModel):
    height: Optional[int] = None

    width: Optional[int] = None


class DataListHeaderThumbs(BaseModel):
...
class DataListSubscribedByDataSubscribe(BaseModel):
...
class DataListSubscribedByData(BaseModel):
    ...
    subscribes: Optional[List[DataListSubscribedByDataSubscribe]] = None

    unsubscribe_reason: Optional[str] = FieldInfo(alias="unsubscribeReason", default=None)


class DataListSubscribedOnData(BaseModel):
    discount_finished_at: Optional[str] = FieldInfo(alias="discountFinishedAt", default=None)
...
class DataListSubscriptionBundle(BaseModel):
    id: Optional[int] = None

    can_buy: Optional[bool] = FieldInfo(alias="canBuy", default=None)
...
class DataList(BaseModel):
    ...
    avatar_thumbs: Optional[DataListAvatarThumbs] = FieldInfo(alias="avatarThumbs", default=None)
    ...
    header_size: Optional[DataListHeaderSize] = FieldInfo(alias="headerSize", default=None)

    header_thumbs: Optional[DataListHeaderThumbs] = FieldInfo(alias="headerThumbs", default=None)
    ...
    promo_offers: Optional[List[object]] = FieldInfo(alias="promoOffers", default=None)
    ...
    subscribed_by_data: Optional[DataListSubscribedByData] = FieldInfo(alias="subscribedByData", default=None)
    ...
    subscribed_on_data: Optional[DataListSubscribedOnData] = FieldInfo(alias="subscribedOnData", default=None)
    ...
    subscription_bundles: Optional[List[DataListSubscriptionBundle]] = FieldInfo(
        alias="subscriptionBundles", default=None
    )
...
class FanListExpiredResponse(BaseModel):
