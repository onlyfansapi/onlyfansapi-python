...
__all__ = [
    ...
    "DataHeaderThumbs",
    "DataListsState",
    "DataSubscribedByData",
    "DataSubscribedByDataSubscribe",
    "DataSubscribedOnData",
    "DataSubscriptionBundle",
]
...
class DataListsState(BaseModel):
...
class DataSubscribedByDataSubscribe(BaseModel):
...
class DataSubscribedByData(BaseModel):
    ...
    subscribes: Optional[List[DataSubscribedByDataSubscribe]] = None

    unsubscribe_reason: Optional[str] = FieldInfo(alias="unsubscribeReason", default=None)


class DataSubscribedOnData(BaseModel):
    discount_finished_at: Optional[str] = FieldInfo(alias="discountFinishedAt", default=None)
...
class DataSubscriptionBundle(BaseModel):
    id: Optional[int] = None
...
class Data(BaseModel):
    ...
    lists_states: Optional[List[DataListsState]] = FieldInfo(alias="listsStates", default=None)
    ...
    subscribed_by_data: Optional[DataSubscribedByData] = FieldInfo(alias="subscribedByData", default=None)
    ...
    subscribed_on_data: Optional[DataSubscribedOnData] = FieldInfo(alias="subscribedOnData", default=None)
    ...
    subscription_bundles: Optional[List[DataSubscriptionBundle]] = FieldInfo(alias="subscriptionBundles", default=None)
...
class RestrictDeleteResponse(BaseModel):
