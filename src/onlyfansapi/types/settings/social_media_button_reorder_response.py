...
__all__ = ["SocialMediaButtonReorderResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits", "Data"]
...
class Data(BaseModel):
    ...
    social_media: Optional[str] = FieldInfo(alias="socialMedia", default=None)
...
class SocialMediaButtonReorderResponse(BaseModel):
