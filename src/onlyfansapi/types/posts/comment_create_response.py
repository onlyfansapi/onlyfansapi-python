...
class DataAuthor(BaseModel):
    ...
    credits_min_alternatives: Optional[int] = FieldInfo(alias="creditsMinAlternatives", default=None)
...
class Data(BaseModel):
    ...
    can_like: Optional[bool] = FieldInfo(alias="canLike", default=None)
    ...
    is_liked_by_author: Optional[bool] = FieldInfo(alias="isLikedByAuthor", default=None)
