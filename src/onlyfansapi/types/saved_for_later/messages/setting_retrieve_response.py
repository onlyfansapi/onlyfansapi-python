...
__all__ = ["SettingRetrieveResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits", "Data"]
...
class Data(BaseModel):
    current_code: Optional[int] = FieldInfo(alias="currentCode", default=None)
