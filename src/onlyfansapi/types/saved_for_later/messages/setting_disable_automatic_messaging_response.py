...
__all__ = ["SettingDisableAutomaticMessagingResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits"]
...
class SettingDisableAutomaticMessagingResponse(BaseModel):
