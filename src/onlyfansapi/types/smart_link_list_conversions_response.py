...
class DataRow(BaseModel):
    ...
    click: Optional[DataRowClick] = None

    conversion_at: Optional[str] = None

    conversion_type: Optional[str] = None

    fan: Optional[DataRowFan] = None

    fan_onlyfans_id: Optional[str] = None


class DataSummary(BaseModel):
    conversions_total: Optional[int] = None

    revenue_total: Optional[float] = None

    subscribers_total: Optional[int] = None
...
class SmartLinkListConversionsResponse(BaseModel):
