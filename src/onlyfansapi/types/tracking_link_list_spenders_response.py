...
__all__ = [
    ...
    "_Meta_RateLimits",
    "Data",
    "DataOnlyfansUserData",
    "DataOnlyfansUserDataListsState",
    "DataOnlyfansUserDataPromoOffer",
    "DataOnlyfansUserDataSubscribedByData",
    "DataOnlyfansUserDataSubscribedByDataSubscribe",
    "DataOnlyfansUserDataSubscribedOnData",
    "DataRevenue",
]
...
class DataOnlyfansUserDataListsState(BaseModel):
...
class DataOnlyfansUserDataPromoOffer(BaseModel):
...
class DataOnlyfansUserDataSubscribedByDataSubscribe(BaseModel):
    id: Optional[int] = None
...
class DataOnlyfansUserDataSubscribedByData(BaseModel):
    ...
    subscribes: Optional[List[DataOnlyfansUserDataSubscribedByDataSubscribe]] = None

    unsubscribe_reason: Optional[str] = FieldInfo(alias="unsubscribeReason", default=None)


class DataOnlyfansUserDataSubscribedOnData(BaseModel):
    discount_finished_at: Optional[str] = FieldInfo(alias="discountFinishedAt", default=None)
    ...
    messages_summ: Optional[float] = FieldInfo(alias="messagesSumm", default=None)
    ...
    subscribes_summ: Optional[float] = FieldInfo(alias="subscribesSumm", default=None)

    tips_summ: Optional[int] = FieldInfo(alias="tipsSumm", default=None)

    total_summ: Optional[float] = FieldInfo(alias="totalSumm", default=None)

    unsubscribe_reason: Optional[str] = FieldInfo(alias="unsubscribeReason", default=None)


class DataOnlyfansUserData(BaseModel):
    id: Optional[int] = None
    ...
    lists_states: Optional[List[DataOnlyfansUserDataListsState]] = FieldInfo(alias="listsStates", default=None)

    name: Optional[str] = None

    notice: Optional[str] = None

    promo_offers: Optional[List[DataOnlyfansUserDataPromoOffer]] = FieldInfo(alias="promoOffers", default=None)
    ...
    subscribed_by_data: Optional[DataOnlyfansUserDataSubscribedByData] = FieldInfo(
        alias="subscribedByData", default=None
    )
    ...
    subscribed_on_data: Optional[DataOnlyfansUserDataSubscribedOnData] = FieldInfo(
        alias="subscribedOnData", default=None
    )
...
class Data(BaseModel):
    ...
    onlyfans_user_data: Optional[DataOnlyfansUserData] = None
...
class TrackingLinkListSpendersResponse(BaseModel):
