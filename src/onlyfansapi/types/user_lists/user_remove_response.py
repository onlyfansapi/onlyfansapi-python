...
class DataListUserAvatarThumbs(BaseModel):
...
class DataListUser(BaseModel):
    ...
    avatar_thumbs: Optional[DataListUserAvatarThumbs] = FieldInfo(alias="avatarThumbs", default=None)
...
class DataList(BaseModel):
    ...
    users: Optional[List[DataListUser]] = None

    users_count: Optional[int] = FieldInfo(alias="usersCount", default=None)


class DataUserState(BaseModel):
    id: Optional[int] = None
...
class Data(BaseModel):
    ...
    user_state: Optional[DataUserState] = FieldInfo(alias="userState", default=None)
