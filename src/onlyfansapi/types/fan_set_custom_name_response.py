...
class DataSubscribedByData(BaseModel):
    ...
    new_posts_after_expire_count: Optional[int] = FieldInfo(alias="newPostsAfterExpireCount", default=None)
...
class Data(BaseModel):
    ...
    subscribed_by: Optional[str] = FieldInfo(alias="subscribedBy", default=None)
...
class FanSetCustomNameResponse(BaseModel):
