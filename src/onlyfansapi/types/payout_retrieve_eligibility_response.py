...
__all__ = ["PayoutRetrieveEligibilityResponse", "_Meta", "_Meta_Cache", "_Meta_Credits", "_Meta_RateLimits", "Data"]
...
class Data(BaseModel):
    ...
    need_update_banking: Optional[bool] = FieldInfo(alias="needUpdateBanking", default=None)


class PayoutRetrieveEligibilityResponse(BaseModel):
